    ...
    <div className="shop">
      ...
      <div className="shopiteams">
        <div className="verticalPart1">
          ...
          <div
            onClick={() => smoothnavigate("/shop")}
            className="bannerofshop"
          ></div>
        </div>
